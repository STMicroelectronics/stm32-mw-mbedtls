...
#define MBEDTLS_KWE_OPAQUE_DRIVER_ID (5)
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_signature_sign_message
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_signature_sign_hash
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_get_key_buffer_size_from_key_data
            (attributes, data,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_generate_key
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            key_buffer_length
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_import_key
            (attributes,
                            data,
                            data_length,
                            key_buffer,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_cipher_encrypt
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_cipher_decrypt
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_aead_encrypt
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_aead_decrypt
            (attributes,
                            key_buffer,
                            key_buffer_size,
                            alg,
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_asymmetric_decrypt
            (attributes,
                            key_buffer, key_buffer_size, alg, input, input_length,
                            salt, salt_length, output, output_size,
                            output_length
...
#if (defined(PSA_KWE_DRIVER_ENABLED) )
        case PSA_CRYPTO_KWE_DRIVER_LOCATION:
            return( mbedtls_kwe_opaque_key_agreement
            (attributes,
                            key_buffer, key_buffer_size, alg, peer_key,
                            peer_key_length, shared_secret, shared_secret_size,
                            shared_secret_length
